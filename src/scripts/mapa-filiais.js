...
export function initFiliaisMap() {
    ...
    if (!coverageFilters) {
        ...
        controls.className = 'coverage-filters';
    ...
    var map = L.map('map').setView([-15.793889, -47.882778], 5);
    ...
    function createPopupContent(filial) {
        return `<strong>${filial.title}</strong><br>Lat: ${filial.lat.toFixed(4)}, Lng: ${filial.lng.toFixed(4)}`;
    }
